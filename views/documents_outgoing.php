...
$documents = $documentFunctions->getDocumentsByType('outgoing');
...
<head>
    ...
    <title>Outgoing Documents - NIA ACIMO</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 class="mb-1 fw-bold text-gradient">Outgoing Documents</h2>
                        <p class="text-muted">Manage all outgoing documents</p>
                    </div>
                    <div>
                ...
                <div class="modern-card">
                    <div class="card-header bg-transparent border-bottom-0 py-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold">
                                <i class="fas fa-paper-plane me-2 text-gradient"></i> Outgoing Documents 
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-modern table-hover" id="outgoingDocumentsTable">
                                <thead>
                                    <tr>
                                        <th>Tracking No.</th>
                                        <th>Document Type</th>
                                    ...
                                    <?php if (empty($documents)): ?>
                                        <tr>
                                            <td colspan="10" class="text-center py-5">
                                                ...
                                                <p class="text-muted">No outgoing documents found</p>
                                            </td>
                                        </tr>
                                    <?php else: ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#outgoingDocumentsTable').DataTable({
                "order": [[7, "desc"]],
                "pageLength": 25
            });
        });
