...
$documents = $documentFunctions->getDocumentsByType('incoming');
...
<head>
    ...
    <title>Incoming Documents - NIA ACIMO</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 class="mb-1 fw-bold text-gradient">Incoming Documents</h2>
                        <p class="text-muted">Manage all incoming documents</p>
                    </div>
                    <div>
                ...
                <div class="modern-card">
                    <div class="card-header bg-transparent border-bottom-0 py-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold">
                                <i class="fas fa-inbox me-2 text-gradient"></i> Incoming Documents 
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-modern table-hover" id="incomingDocumentsTable">
                                <thead>
                                    <tr>
                                        <th>Tracking No.</th>
                                        <th>Document Type</th>
                                    ...
                                    <?php if (empty($documents)): ?>
                                        <tr>
                                            <td colspan="10" class="text-center py-5">
                                                ...
                                                <p class="text-muted">No incoming documents found</p>
                                            </td>
                                        </tr>
                                    <?php else: ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#incomingDocumentsTable').DataTable({
                "order": [[7, "desc"]],
                "pageLength": 25,
                "language": {
