...
body.dark-mode .info-box { background: var(--card-bg) !important; color: var(--text-primary) !important; }
body.dark-mode .info-box-content { color: var(--text-primary) !important; }
</style>
</head>
                ...
                <div id="profileGrid" class="profile-grid-container">
                    <div class="card">
                        ...
                        <div class="profile-card"
                            ...
                            <div class="profile-body" style="color:dark;">
